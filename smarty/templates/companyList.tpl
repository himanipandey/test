        ...
        jQuery(document).ready(function() {
            ...
            $(document).on({
                ajaxStart: function() {
                    ...
                    $("#lmkSave").attr('disabled', true);
                    $("#exit_button").attr('disabled', true);
                    $("#create_button").attr('disabled', true);
                },
                ajaxStop: function() {
                    $body.removeClass("loading");
                    $("#lmkSave").attr('disabled', false);
            ...
            $("#lmkSave").click(function() {
                ...
                if (email == '') {
                    $('#errmsgcompemail').html('<font color="red">Please provide a email address .</font>');
                    $("#compemail").focus();
                    window.error = 1;
                }
                else {
                    ...
                    if (!emailReg.test(email)) {
                        $('#errmsgcompemail').html('<font color="red">Invalid email address .</font>');
                        $("#compemail").focus();
                        window.error = 1;
                    }
                    else {
                                                ...
                                                <TABLE cellSpacing=2 cellPadding=4 width="93%" align="left" border=0 id="main_table">
                                                    <form method="post" enctype="multipart/form-data" id="formlmk" name="formlmk">
                                                        ...
                                                        <div>
                                                            ...
                                                            <tr class="broker_basic">
                                                                <td width="20%" align="right" ><font color = "red">*</font>Office Email : </td>
