                ...
                <TD vAlign=top align=middle class="backgorund-rt" height=450><BR>
                    ...
                    <form name="form1" method="post" action="">
                      <TBODY>
                        ...
                        <TD class=whiteTxt width=15% align="left">Company</TD>
                        ...
                        <TD class=whiteTxt width=25% align="left">Phone 1</TD>
                        <TD class=whiteTxt width=25% align="left">Phone 2</TD>
                        <TD class=whiteTxt width=15% align = 'left'>Fax</TD>
                      ...
                      <TR {$color}>
                        ...
                        <TD align=left class=td-border>{$value['addressline1']}</TD>
                        <TD align=left class=td-border>{$value['label']}</TD>
                        <TD align=left class=td-border>{$value['phone1']}</TD>
                        <TD align=left class=td-border>{$value['phone2']}</TD>
                        <TD align=left class=td-border>{$value['fax']}</TD>
                        <TD align=left class=td-border>{$value['email']}</TD>
                        ...
                        <TD align=left class="td-border">
			                 <a href="brokercompanyadd.php?brokerCompanyId={$value['id']}&citylocids={$value['cityloc']}&contacts={$value['contacts']}&mode=edit&page={$page}&sort={$sort}" title="{$value->name}">EDIT </a>
                          </TD>
                      </TR>
                       {/foreach}
                        {if $NumRows<=0}
