...
function selectNearPlaceTypes(value){ 
  ...
  window.location.href="{$dirname}/locality_near_places_priority.php?citydd="+cityid+"&locality="+locality_id+"&suburb="+suburb_id+"&near_place_type="+value;
}
                                ...
                                <td width="20%" height="25" align="left" valign="top">
                                    <select id="loc" name="loc" onchange="selectNearPlaceTypes(this.value)">
                                       ...
                                       {foreach from=$nearPlaceTypesArray key=k item=v}
                                              <option value="{$k}" {if $nearPlaceTypesId==$k}  selected="selected" {/if}>{$v}</option>
                                       {/foreach}
                                    </select>
                                </td>
                        ...
                        <form name="form1" method="post" action="">
                          <thead>
                                <TR class = "headingrowcolor">
                                  ...
                                  <TH width=5% align="center">Edit Priority</TH>
                                </TR>
