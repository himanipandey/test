...
if ($_GET['sort'] == "1") {
    $QueryMember = "Select * FROM ".RESI_BUILDER." WHERE BUILDER_NAME BETWEEN '0' AND '9'  ORDER BY BUILDER_ID DESC";
} else if ($_GET['sort'] == "all") {
    $QueryMember = "Select * FROM ".RESI_BUILDER." WHERE 1  ORDER BY BUILDER_ID DESC";
} else {
    $QueryMember = "Select * FROM ".RESI_BUILDER." WHERE  left(BUILDER_NAME,1)='".$_GET['sort']."' ORDER BY BUILDER_ID DESC";
}
