...
<script type="text/javascript">
	...
	function towerSelect(towerId)
	{
		...
		window.location="tower_detail_edit.php?towerId="+towerId+"&projectId="+projectId;
	}
</script>
              ...
              <TR>
                <TD class=h1 align=left background=images/heading_bg.gif bgColor=#ffffff height=40>
                  <TABLE cellSpacing=0 cellPadding=0 width="99%" border=0>
					<TBODY>
						<TR>
						  <TD class="h1" width="67%"><img height="18" hspace="5" src="../images/arrow.gif" width="18">Edit Tower Detail({$ProjectDetail[0]['BUILDER_NAME']} {$ProjectDetail[0]['PROJECT_NAME']})</TD>
					 ...
					 <form method="post" id="formss" enctype="multipart/form-data">
							   ...
							   <tr>
								  ...
								  <td width="30%" align="left">
									 ...
									 <select  name="TowerId" class="TowerId" id="TowerId" onchange = "towerSelect(this.value);">
										<option value = "">Select Tower</option>
										{foreach from = $towerDetail key = key item = item}
											<option value = "{$item['TOWER_ID']}" {if $towerId == $item['TOWER_ID']} selected {/if}>{$item['TOWER_NAME']}</option>
										{/foreach}
									 </select>
							  ...
							  <tr>
							   ...
							   <tr>
								  ...
								  <td align="left" style="padding-left:0px;">
									...
									<input type="submit" name="btnSave" id="btnAddMore" value="Edit More"  onclick="return project_scn3();"/>
