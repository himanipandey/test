...
function validation()
	{
		...
		if(ct == '' && loc == '' && bldr == '' && project_name == '' && phase=='' && stage=='' && pid == '' && Availability == null && Residential == '' && Active == null  && Status == null  && project_name == '' && f_date_c_from =='' && f_date_c_to =='')
		{
			$("#errmsg").show();
			return false;
		}
                    ...
                    {if $accessBulkProject == ''}
                            <form name='search' method="post" onsubmit = "return validation();">
                                      <center><table width="530" border="0" align="left" cellpadding="0" cellspacing="1" bgColor="#fcfcfc" style = "border:1px solid #c2c2c2;margin: 20px;">
                                            ...
                                            <tr bgcolor='#fcfcfc'>
                                                    <td align="right" style = "padding-left:20px;" height='35'><b>Active:</b></td>
