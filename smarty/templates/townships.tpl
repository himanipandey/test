        ...
        <TR>
          ...
          <TD vAlign=top align=middle width="100%" bgColor=#eeeeee height=400>
              ...
              <TR>
                <TD class=h1 align=left background=../images/heading_bg.gif bgColor=#ffffff height=40>
                  <TABLE cellSpacing=0 cellPadding=0 width="99%" border=0><TBODY>
                    <TR>
                      <TD class=h1 width="67%"><IMG height=18 hspace=5 src="../images/arrow.gif" width=18>TownShips List</TD>
                      <TD align=right colSpan=3>
                          <a href="townshipsAdd.php" style=" font-size:15px; color:#1B70CA; text-decoration:none; "><b>Add Townships</b></a>
                          </TD>
                    </TR>
		  </TBODY></TABLE>
		</TD>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="77%" height="25" align="center" style="padding-top:30px;padding-bottom:10px;">
                                <form name="frm_build" id="frm_build" method="post" action ="townships.php?page=1&sort=all">
			...
			<TD class=whiteTxt width=15% align="left">Name</TD>
                      ...
                      {$count = 0}
                        {foreach from = $townshipsArr key = key item = item}
                            {$count = $count+1}
                            {if $count%2 == 0}
