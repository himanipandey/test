	...
	<tr>
        ...
        {/if}
            ...
            <tr>
                <td class="blue_txt" nowrap align="left" width="2%" height="22"><img height="9" src="{$OFFLINE_PROJECT_POPUP_IMAGE_PATH}plus.gif" width="9">&nbsp;</td>
                <td align="left" height="22"><a class="leftnav" href="ruleadd.php"><font color = "#f15a22">Rules Managment</font></a></td>
            </tr>
            <tr>
                <td class="blue_txt" nowrap align="left" width="2%" height="22"><img height="9" src="{$OFFLINE_PROJECT_POPUP_IMAGE_PATH}plus.gif" width="9">&nbsp;</td>
                <td align="left" height="22"><a class="leftnav" href="SellerCompanyList.php"><font color = "#f15a22">Seller Company Management</font></a></td>
            </tr>
	       <tr>
                <td class="blue_txt" nowrap align="left" width="2%" height="22"><img height="9" src="{$OFFLINE_PROJECT_POPUP_IMAGE_PATH}plus.gif" width="9">&nbsp;</td>
                <td align="left" height="22"><a class="leftnav" href="BrokerCompanyList.php"><font color = "#f15a22">Broker Company Management</font></a></td>
            </tr>
