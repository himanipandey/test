...
WHERE trp.PROJECT_ID='$projectID' AND (trp.PROJECT_STAGE_ID = '$projectStageId' && trp.PROJECT_PHASE_ID = 4) AND trp.version = 'Cms' ORDER BY trp._t_transaction_id DESC LIMIT 1") or die(mysql_error());
