...
ContactPop = {
    ...
    appendOverlay : function() {
		...
		ContactPop.obj.panelHeadline = $( '<span id="username" style ="display:none;">' + username + '</span>') . appendTo( ContactPop.obj.panel );
		...
		//ContactPop.obj.loading = jQuery('<div id="username"></div>').username );
