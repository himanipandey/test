...
if (count($dataAmenityId) > 0) {
    $resProjectAmenityId = $dataAmenityId['id'];
}
...
if (ProjectMigration::isProjectWaitingForMigration($projectId))
    die('This project is being migrated to website. You will be able to see project details only after some time.');
...
//  Get back older history
    ...
    if (($_REQUEST['returnStage'] == 'NewProject' || $_REQUEST['returnStage'] == 'UpdationCycle') && ($_REQUEST['currentPhase'] == 'Audit1' OR $_REQUEST['currentPhase'] == 'Audit2')) {
