<?php
   ...
   /******code for get all project which have master plans***/
    ...
    $activeProjectWithUnderConst = ResiProject::find('all',array('conditions'=>array("(active = '1' OR active = '3') AND residential = '0' AND city_id in ($cityList) AND  project_status = 'Under Construction'" ),
        "select" => "count(*) as PROJECT_COUNT"));
