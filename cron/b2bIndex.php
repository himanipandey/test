...
$globalCondition = "(rp.updation_cycle_id != 15 or rp.updation_cycle_id is null) and rp.STATUS in ('Active', 'ActiveInCms') and rp.RESIDENTIAL_FLAG = 'Residential' and psm.project_status not in ('Cancelled', 'OnHold', 'NotLaunched') and rpp.status = 'Active' and li.status = 'Active' and li.listing_category = 'Primary' and rp.version = 'Website' and rpo.OPTION_CATEGORY in ('Actual', 'Logical')";
