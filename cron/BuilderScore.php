...
$__param_multiplication_factor = array( 'SQRF_AREA_COMPLETED' => 0.20,
					'SQRF_AREA_UNDER_CONSTRUCTION_And_Pre_Launch' => 0.30,
					'BUILDER_OVERALL_DELAY' => 0.05,'RATE_OF_SALE' => 0.20,
					'ESTABLISED_TIME' => 0.20);
...
$__builder_api_respose = file_get_contents('https://qa.proptiger-ws.com/data/v1/entity/builder?selector={"fields":["id","establishedDate"],"paging":{"start":0,"rows":10000}}');
...
$__api_respose = file_get_contents('http://localhost:8080/data/v1/entity/builder?selector={"fields":["id","isBuilderListed"],"paging":{"start":0,"rows":10000}}');
...
foreach($__listed_array as $__id => $__value){
	$__id_is_builder_listed_map[$__value['id']] = $__value['isBuilderListed'];
}
