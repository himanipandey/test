...
$updateISSmoothed = $_REQUEST['updateSmoothed'];
...
if ($search != '' OR $transfer != '' OR $_POST['projectId'] != '' OR $updateRemark != '' OR $updateISSmoothed != '') {
...
//             if($skipB2B==''){
//                $QueryMember .= $and ." version = 'Cms' and (updation_cycle_id != ".skipUpdationCycle_Id." OR updation_cycle_id is null) ";
//             }
//             else{
//                $QueryMember .= $and ." version = 'Cms' and (updation_cycle_id != ".skipUpdationCycle_Id." OR updation_cycle_id is null) and SKIP_B2B ='".$skipB2B."' ";
//             }
...
//            if($skipB2B=='') {
//                $QueryMember .= $and. " PROJECT_ID IN (".$_REQUEST['projectId'].") AND version = 'Cms' and (updation_cycle_id != ".skipUpdationCycle_Id." OR updation_cycle_id is null) ";
//            }
//            else {
//                $QueryMember .= $and. " PROJECT_ID IN (".$_REQUEST['projectId'].") AND version = 'Cms' and (updation_cycle_id != ".skipUpdationCycle_Id." OR updation_cycle_id is null) and SKIP_B2B ='".$skipB2B."' ";
//            }
...
if ($updateISSmoothed != '' && trim($_POST['is_smoothed_flag']) != '') {
    $arrPropId = array();
    ...
    if ($NumRows > 0) {
        ...
        //update projects
        $Qry = " UPDATE resi_project SET IS_SMOOTHED = ".$_POST['is_smoothed_flag']." ,updated_by = '" . $_SESSION['adminId'] . "'
                                WHERE PROJECT_ID IN (" . $getProjectId . ") AND version = 'Cms'";
