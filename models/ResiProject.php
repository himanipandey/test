...
class ResiProject extends Objects
{
   ...
   static function getAllSearchResult($arrSearch) {
      ...
      /* elseif($key == 'govtProjects_flag'){
        if($value=='govtProjects'){
          $conditions .= " ta.attribute_name='GOVT_PROJECT' AND ta.attribute_value='1' "
        }
        elseif($value=='nonGovtProjects'){
          $conditions .= " ta.attribute_name='GOVT_PROJECT' AND ta.attribute_value='0' "
        }
       }*/
    	 else {
    		 if(is_array($value))
