    ...
    if($mode=='update' && $id!==null){
        ...
        if(mysql_affected_rows()>0){
            ...
            if(mysql_affected_rows()>0){
                ...
                //var_dump($dataArr);
                $query3 = "UPDATE contact_numbers SET contact_no='{$compphone}', updated_by={$_SESSION['adminId']}, updated_at=NOW() WHERE (table_name='broker_contacts' and table_id='{$broker_contacts_id}' and type='cc_phone')";
    ...
    if ($mode=='create'){
        ...
        if(mysql_affected_rows()>0){
            ...
            if(mysql_affected_rows()>0){
                ...
                $query3 = "INSERT INTO contact_numbers (table_name, table_id, contry_code, contact_no, type, updated_by, created_at) values ('broker_contacts', '{$broker_contacts_id}', '+91', '{$compphone}', 'cc_phone', {$_SESSION['adminId']}, NOW())";
